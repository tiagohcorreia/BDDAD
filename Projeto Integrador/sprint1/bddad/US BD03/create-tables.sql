CREATE TABLE Aplicacao_FP (operacao_id number(10) NOT NULL, parcela_id number(10) NOT NULL, variedade_id number(10), fator_producao_id number(10) NOT NULL, metodo_aplicacao_id number(10) NOT NULL, quantidade float(10) NOT NULL, PRIMARY KEY (operacao_id));
...
CREATE TABLE Metodo_Dispensasao (id number(10) GENERATED AS IDENTITY, nome nvarchar2(255) NOT NULL, PRIMARY KEY (id));
CREATE TABLE Metodo_Execucao (id number(10) GENERATED AS IDENTITY, nome nvarchar2(255) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Op_Plantacao (operacao_id number(10) NOT NULL, parcela_id number(10) NOT NULL, variedade_perm_id number(10) NOT NULL, metodo_execucao_id number(10), quantidade number(10) NOT NULL, PRIMARY KEY (operacao_id));
...
CREATE TABLE Produto (id number(10) GENERATED AS IDENTITY, nome nvarchar2(255) NOT NULL, variedade_id number(10) NOT NULL, PRIMARY KEY (id));
CREATE TABLE Rega (operacao_id number(10) NOT NULL, setor_id number(10) NOT NULL, duracao number(10) NOT NULL, PRIMARY KEY (operacao_id));
CREATE TABLE Registro_Sensor (id number(10) GENERATED AS IDENTITY, sensor_id number(10) NOT NULL, valor float(10) NOT NULL, PRIMARY KEY (id));
CREATE TABLE Sementeira (operacao_id number(10) NOT NULL, parcela_id number(10) NOT NULL, variedade_temp_id number(10) NOT NULL, quantidade float(10) NOT NULL, area float(10) NOT NULL, metodo_execucao_id number(10), PRIMARY KEY (operacao_id));
CREATE TABLE Sensor (id number(10) GENERATED AS IDENTITY, parcela_id number(10) NOT NULL, tipo_sensor_id number(10) NOT NULL, PRIMARY KEY (id));
CREATE TABLE Setor_Rega (id number(10) GENERATED AS IDENTITY, area float(10), caudal_maximo float(10) NOT NULL, data_inicio number(10) NOT NULL, data_fim number(10), metodo_dispensasao_id number(10), PRIMARY KEY (id));
...
CREATE TABLE Tipo_Sensor (id number(10) GENERATED AS IDENTITY, nome nvarchar2(255) NOT NULL, unidade nvarchar2(255), PRIMARY KEY (id));
...
CREATE TABLE Variedade (id number(10) GENERATED AS IDENTITY, nome nvarchar2(255) NOT NULL, cultura_id number(10) NOT NULL, PRIMARY KEY (id));
...
ALTER TABLE Op_Plantacao ADD CONSTRAINT FKOp_Plantac142261 FOREIGN KEY (variedade_perm_id) REFERENCES Variedade_Permanente (variedade_id);
ALTER TABLE Sementeira ADD CONSTRAINT FKSementeira68640 FOREIGN KEY (variedade_temp_id) REFERENCES Variedade_Temporaria (variedade_id);
